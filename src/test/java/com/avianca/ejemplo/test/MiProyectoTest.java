package com.avianca.ejemplo.test;
 ...
 *
 */
public class MiProyectoTest extends CamelSpringTestSupport {
	...
	testProperties.load(MiProyectoTest.class.getResourceAsStream("/misproperties.properties"));
    }
